...
export function Toolbox() {
  ...
  return (
    <div className="min-h-screen px-4 py-6">
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-white mb-2">Your Toolbox</h1>
      ...
      {items.length === 0 && (
        <Card className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-white mb-2">Your toolbox is empty</h3>
          ...
          >
            ...
            >
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold text-white">Add to Toolbox</h2>
                <button
                  onClick={() => setShowAddModal(false)}
                  className="p-2 rounded-full bg-slate-700 text-slate-400"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full bg-slate-700 border border-slate-600 rounded-xl p-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                />
              </div>
              ...
              <div className="mb-4">
                ...
                <textarea
                  ...
                  className="w-full h-24 bg-slate-700 border border-slate-600 rounded-xl p-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none"
                />
              </div>
      ...
      <AnimatePresence>
        {showActions && (
          <motion.div
            ...
            className="mt-3 pt-3 border-t border-slate-700 flex gap-2"
          >
            <Button
              variant="ghost"
              size="sm"
              ...
              className="flex-1"
            >
              <Star className={`w-4 h-4 mr-1 ${item.isFavorite ? 'fill-yellow-400 text-yellow-400' : ''}`} />
